{include file="header.tpl" title="妖怪ウォッチ　グッズ"}
	{block name=head}
		<link rel="stylesheet" href="{$baseurl}/category_style.css" type="text/css">
	{/block}
</head>
			...
			<div class="header-v1">
				<header id="header">
					<div class="avada-row" style="margin-top:0px;margin-bottom:0px;">
						<div class="logo_v1">
							<div class="face">
								<img src="{$baseurl}/images/img/header/logo_face.png" alt="妖怪ウォッチ　グッズ" class="normal_logo" />
							</div>
											...
											<div class="home_post_border_1">
												<div id="post-goods">
													<div class="post-content-container" >
														<div class="post_list">
															<div class="post_img">
																<a href="p2218/index.html" ><img alt="main_image" src="../../wp-content/uploads/2015/05/food-ジバニャンのふわチョコモナカ_1.jpg" /></a>
															</div>
											...
											<div class="home_post_border_1">
												<div id="post-goods">
													<div class="post-content-container" >
														<div class="post_list">
															<div class="post_img">
																<a href="../../p2211/index.html" ><img alt="main_image" src="../../wp-content/uploads/2015/04/prize-カード付折りたたみウォレット２-1.jpg" /></a>
															</div>
															<div class="catpost_right">
																<div class="title_post">
																...
																<div class="post-new">
																	<img alt="youkai_new_show_important" src="Avada/images/img/new_icon.png">
																</div>
																<div class="catlower">
																	<div class="post-date-youkai">
																		<p class="single-line-meta">
